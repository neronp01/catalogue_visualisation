...
gulp.task('scripts', () =>
  gulp.src([
    ...
    './app/scripts/components/voronoi/voronoi.js',
    './app/scripts/components/pie/simplePie.js'
  ])
...
gulp.task('copy-sw-scripts', () => {
  return gulp.src(['node_modules/sw-toolbox/sw-toolbox.js','app/scripts/d3/d3.js', 'app/scripts/sw/runtime-caching.js'])
